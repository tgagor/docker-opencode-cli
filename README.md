...
*   [`v1.18.18`](https://hub.docker.com/r/tgagor/opencode-cli/tags) (e.g., `v0.11.0`): Corresponds to a specific version of the OpenCode.
*   [`v1.18`](https://hub.docker.com/r/tgagor/opencode-cli/tags) (e.g., `v0.11`): Points to the latest patch release for a minor version.
